                                   ...
                                   while($row = $result1->fetch_assoc()) { 
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <a href="deletestaffphp.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-danger" >Delete</button></a>
...
<form name="form1" onsubmit="return emptyValidation()" action="addstaff.php"  method="post" >
<h1>Staff details</h1>
<p>   
<input style="visibility:hidden" id="staffid" name="staffid" value="<?php echo $rowcount ?>"></input></br></p>
<label class="lab" style="padding-right:20px;" for="staffname" >Staff Name   :</label></br>
<input id="staffname" type="text" name="staffname"></input></br></p>
<label class="lab" style="padding-right:20px;" for="staffrole" >Role   :</label></br>
<input id="staffrole" type="text" name="staffrole"></input></br></p>
<label class="lab" style="padding-right:20px;" for="staffphone" >Phone   :</label></br>
<input id="staffphone" type="text" name="staffphone"></input></br></p>
<label class="lab" style="padding-right:20px;" for="staffsalary" >Salary    :</label></br>
<input id="staffsalary" type="text" name="staffsalary"></input></br></p>
